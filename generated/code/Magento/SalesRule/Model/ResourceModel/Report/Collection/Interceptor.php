...
class Interceptor extends \Magento\SalesRule\Model\ResourceModel\Report\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRuleFilter');
        return $pluginInfo ? $this->___callPlugins('addRuleFilter', func_get_args(), $pluginInfo) : parent::addRuleFilter($rulesList);
    }

...
class Interceptor extends \Magento\Reports\Model\Grouped\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setColumnGroupBy');
        return $pluginInfo ? $this->___callPlugins('setColumnGroupBy', func_get_args(), $pluginInfo) : parent::setColumnGroupBy($column);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setResourceCollection');
        return $pluginInfo ? $this->___callPlugins('setResourceCollection', func_get_args(), $pluginInfo) : parent::setResourceCollection($collection);
    }
